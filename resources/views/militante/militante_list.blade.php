          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3 pull-right">
                <a href='{{url("militante")}}' class="btn btn-block btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Militante</a>
              </div>
              <div class="col-lg-3 pull-right">
                <a href='{{url("militante/download")}}' class="btn btn-block btn-success">Download XLS</a>
              </div>
              ...
              <thead>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $militante) {
                                            ...
                                            <a class="" href="/militante/edit/'.$militante->id.'" title="Edit" ><i  data-feather="edit-2" class="fa fa-edit"></i></a>&nbsp;
                                            <a class="" href="/cetak/militante/'.$militante->id.'" title="Cetak Surat" ><i data-feather="print"  class="fa fa-print"></i></a>&nbsp;
                                            <a class="" href="javascript:void(0)" title="Delete" onclick="delete_user(' . "'" . $militante->id . "'" . ')"><i  data-feather="trash" class="fa fa-trash"></i></a>
...
<script type="text/javascript">
  ...
  function delete_user(iduser) {
    if (confirm('Are you sure delete this data?')) {
      ...
      $.ajax({
        url: "{{url('militante/delete')}}/" + iduser,
        type: "GET",
        dataType: "JSON",
