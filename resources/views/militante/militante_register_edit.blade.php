              ...
              <div class='card card-primary'>
                  ...
                  <div class='card-body'>
						...
						<form action="javascript:save()" id="form1" name="form1" class="form-horizontal" method='POST' enctype="multipart/form-data" >
                                        ...
                                        <input type="text" class="form-control" id="id"  name="id" value="{{$register->id}}">
              <div class='card card-primary'>
								<div class='card-header with-border'>
									...
									<div>
                                              <div class="row">
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-md-12">
                                                    <select name="kabupatentim" id="kabupatentim" class="form-control" required disabled> 

                                                    
                                                    <?php
                                                      $listkabupaten = DB::table('kabupaten')->where('idkabupaten',$register->kabupaten_id)->get();
                                                      ?>  
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-md-12">
                                                  <select name="kecamatantim" id="kecamatantim" value="" class="form-control" required disabled>

                                                  <?php
                                                      $listkabupaten = DB::table('kecamatan')->where('idkecamatan',$register->kecamatan_id)->get();
                                                      ?>  
                                                      <?php foreach ($listkabupaten as $list) {?>
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-md-12">
                                                  <input type="text" class="form-control" id="nobukti"  name="nobukti" value="{{$register->no_bukti}}" disabled>
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-md-12">
                                                  <input type="date" class="form-control" name="tanggal" value="{{$register->tanggal}}"  required disabled>
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-md-12">
                                                  <select name="vip" class="form-control" required disabled>
                                                  <?php if($register->vip==1) { ?>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-md-4">
                                                  <input type="number" class="form-control" name="buletin1" value="{{$register->no_buletin1}}"  required>
                                                  </div>
                                                  ...
                                                  <div class="col-md-4">
                                                  <input type="number" class="form-control" name="buletin2" value="{{$register->no_buletin2}}"  required>
                                                  </div>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-md-12">
                                                      <textarea name="keterangan" rows="5" class="form-control">{{$register->keterangan}}</textarea>
                                                  </div>
                                                </div>
