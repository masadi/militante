...
<link href="{{url('app-assets/signature/jquery.signature.css')}}" rel="stylesheet">
<style>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12"><?php $end = date('Y-m-d', strtotime('+5 years'));?>
                                                    <input type="text" class="form-control pickadate" id="date3" name="validuntil" placeholder="Nama Lengkap" value="<?php echo $end;?>"    required='required'>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="number"  class='form-control' id="usia" name="usia" placeholder="Usia" value="" >
                                                  </div>
                                                </div>
...
<script src="{{url('app-assets/signature/jquery.signature.js')}}"></script>
<script>
$(function() {
...
<script>
    var baseUrl = "{{url('militante')}}/";
        ...
        function xsearchno() {
            var form = $('#form1')[0];
            var formData = new FormData(form);
            var kabupatentim = document.getElementById("kabupatentim").value;
            var kecamatantim = document.getElementById("kecamatantim").value
            var vip = 0;
            ...
            $.ajax({
                url: baseUrl + 'searchno',
                dataType: 'json',
                method: 'post',
                data: 'kabupaten='+kabupatentim+'&kecamatan='+kecamatantim+'&vip='+vip+'&_token='+token,
                contentType: false,
                processData: false,
                success: function(data) {
                    console.log(data);
                    if (data.status) {
                            document.getElementById("nomilitante").value = data.status;

                            call_alert('success', 'Success', 'Data saved successfully.');
                    } else {
                        call_alert('error', 'Warning', 'Failed to No. Militante...');
                    }
                },
                error: function() {
                    call_alert('error', 'Warning', 'Failed to No. Militante..');
