									...
									<div>
                                              <div class="row">
                                                <div class="form-group  row col-md-3">
                                                  <label for="tahunlulus" class="col-sm-12 control-label labelbold">Municipiu</label>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <?php
                                                      $listkabupaten = DB::table('kelurahan')->where('idkelurahan',$militante->kelurahan_id)->get();
                                                      ?>  
                                                      <?php foreach ($listkabupaten as $list) {?>
                                                      <option value="{{ $list->kode_suco }}" ><?php echo $list->kode_suco . ' | ' . $list->nama_suco;?></option>
                                                      <?php } ?>
                                                    </select>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <?php
                                                      $listkabupaten = DB::table('tps')->where('idtps',$militante->desa_id)->get();
                                                      ?>  
                                                      <?php foreach ($listkabupaten as $list) {?>
                                                      <option value="{{ $list->kode_aldeia }}" ><?php echo $list->kode_aldeia . ' | ' . $list->nama_aldeia;?></option>
                                                      <?php } ?>
                                                    </select>
								...
								<div class='card-body'>
									<div>
                                              ...
                                              <div class="card-footer">
                                                <a href="{{url('militante/list')}}" class="btn btn-danger">Back to List</a>
