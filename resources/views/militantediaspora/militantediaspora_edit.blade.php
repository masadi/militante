								...
								<div class='card-body'>
									<div>
                                              ...
                                              <div class="form-group  row col-md-3">
                                                  <label for="tahunlulus" class="col-sm-12 control-label labelbold">Negara</label>

                                                  <input type="hidden" class="form-control" id="id" name="id"  value="{{$militante->id}}"    required='required'>
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <?php
                                                      ...
                                                      <option value="{{ $list->kode_district }}" ><?php echo $list->kode_district . ' | ' . $list->nama_district;?></option>
                                                      <?php } ?>

                                                    <?php
                                                      $listkabupaten = DB::table('kabupaten')->where('kelompok_district','LUAR NEGERI')->get();
                                                      ?>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  <label for="kecamatantim" class="col-sm-12 control-label">Kota</label>

                                                  <div class="col-md-12">
                                                  <select name="kecamatantim" id="kecamatantim" value="" class="form-control" required >
                                                      
                                                      <?php
                                                      $listkabupaten = DB::table('kecamatan')->where('idkecamatan',$militante->kecamatan_id)->get();
                                                      ?>  
                                                      <?php foreach ($listkabupaten as $list) {?>
                                                      <option value="{{ $list->kode_subdistrict }}" ><?php echo $list->kode_subdistrict . ' | ' . $list->nama_subdistrict;?></option>
                                                      <?php } ?>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <label for="nik" class="col-sm-12 control-label">Alamat</label>

                                                  <div class="col-sm-10">
                                                    <textarea  class="form-control" rows="5" id="alamatdiaspora" name="alamatdiaspora" placeholder="Alamat"  required='required'>{{$militante->alamatdiaspora}}</textarea>
                                                  </div>
                                                </div>
									...
									<div>
                                              <div class="row">
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="nomilitante" name="nomilitante" placeholder="No Militante" value="{{$militante->no_militante}}"    required='required' readonly>
                                                  </div>
                                                  <div class="col-sm-1">
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input  type="text" class="form-control pickadate" id="date1" name="tanggal"  value="{{$militante->tanggal}}"    required='required'>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="noelektor" name="noelektor" placeholder="No Elektor" value="{{$militante->no_elektor}}"    required='required'>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input  type="text" class="form-control pickadate" id="date2" name="tanggalterbit"  value="{{$militante->tgl_terbit}}"    required='required'>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input  type="text" class="form-control pickadate" id="date3" name="validuntil" value="{{$militante->valid_until}}"    required='required'>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="{{$militante->nama}}"    required='required'>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group row col-md-8">
                                                    ...
                                                    <div class="col-sm-4">
                                                      <input type="text" class="form-control" id="tempatlahir" name="tempatlahir" placeholder="Tempat Lahir" value="{{$militante->tempat_lahir}}"  maxlength='20'   required='required'>
                                                    </div>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text"  class='form-control' id="usia" name="usia" placeholder="Usia" value="{{$militante->usia}}" >
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="jeniskelamin" name="jeniskelamin" placeholder="Jenis Kelamin"  required='required'>
                                                        ...
                                                        <?php if ($militante->jenis_kelamin=="L") { ?>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="agama" name="agama" placeholder="Agama" required='required'>
                                                      <option value="{{$militante->agama}}">{{$militante->agama}}</option>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="namaayah" name="namaayah" placeholder="Nama Ayah" value="{{$militante->nama_ayah}}"    >
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="namaibu" name="namaibu" placeholder="Nama Ibu" value="{{$militante->nama_ibu}}"    >
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <textarea  class="form-control" rows="5" id="alamat" name="alamat" placeholder="Alamat"  required='required'>{{$militante->alamat}}</textarea>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-3">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="telepon" name="telepon" placeholder="Telepon" value="{{$militante->telepon}}"   >
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-4">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="{{$militante->email}}"   >
                                                  </div>
                                                </div>
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <textarea  class="form-control" rows="10" id="keterangan" name="keterangan" placeholder="Keterangan" >{{$militante->keterangan}}</textarea>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="periode" name="periode"  >
                                                        ...
                                                        <?php if($militante->periode==$list->id) {?><option value="{{ $list->id }}" selected>{{ $dt_option }}</option>
                                                        <?php } else { ?>
                                                          <option value="{{ $list->id }}" >{{ $dt_option }}</option>
                                                        <?php } ?>
                                                        <?php } ?>
                                                    </select>
                                                  </div>
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan">
                                                        <?php
                                                        $jabatan = DB::table('kargoaktual')->where('id',$militante->jabatan_id)->get();
                                                        ?>

                                                        <?php foreach ($jabatan as $list) { ?>
                                                        <option value={{$militante->jabatan_id}}>{{$list->name}}</option>
                                                        <?php } ?>
                                                        <?php
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <select class="form-control" id="profesi" name="profesi" placeholder="Profesi">
                                                        <?php
                                                        $profesi = DB::table('profisaun')->where('id',$militante->profesi_id)->get();
                                                        ?>

                                                        <?php foreach ($profesi as $list) { ?>
                                                        <option value={{$militante->profesi_id}}>{{$list->name}}</option>
                                                        <?php } ?>
                                                    <?php
									...
									<div>
                                             ...
                                             <div class="row">
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input  type="text" class="form-control pickadate" id="date5" name="tglinput"  value="{{$militante->tgl_input}}" >
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input  type="text" class="form-control pickadate" id="date6" name="tgledit"   value="{{$militante->tgl_edit}}">
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="oprinput" name="oprinput"  value="{{$militante->opr_input}}">
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="opredit" name="opredit"  value="{{$militante->opr_edit}}">
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="distrikinput" name="distrikinput" value="{{$militante->distrik_input}}" >
                                                ...
                                                <div class="form-group  row col-md-6">
                                                  ...
                                                  <div class="col-sm-12">
                                                    ...
                                                    <?php if($militante->cetak_kartu==1) { ?>
									...
									<div>
                                              ...
                                              <div class="row">
                                                                <div class="form-group col-lg-12">
                                                                  ...
                                                                  <?php /*<input type="file" class="form-control"  name="photo">
                                                                  <br>
                                                                ...
                                                                <div class="form-group col-lg-12">
                                                                  ...
                                                                  <?php /*<input type="file" class="form-control" name="filesignature">
                                                                  <br>
                                              ...
                                              <div class="card-footer">
                                                <button type="submit" name="btnupload" class="btn btn-success ">SAVE MILITANTE</button>
                                              </div>
									</div>
								</div>
							</div>
...
<script>
    var baseUrl = "{{url('militantediaspora')}}/";
