									...
									<div>
                                              <div class="row">
                                                ...
                                                <div class="form-group  row col-md-12">
                                                  ...
                                                  <div class="col-sm-10">
                                                    <textarea  class="form-control" rows="5" id="alamatdiaspora" name="alamatdiaspora" placeholder="Alamat"  required='required'></textarea>
                                                  </div>
                                                </div>
								...
								<div class='card-body'>
									<div>
                                              ...
                                              <div class="card-footer">
                                                <a href="{{url('militantediaspora/list')}}" class="btn btn-danger">Back to List</a>
                                                <button type="submit" name="btnupload" class="btn btn-success ">SAVE MILITANTE DIASPORA</button>
                                              </div>
									</div>
								</div>
							</div>
