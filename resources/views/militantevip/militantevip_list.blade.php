          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3 pull-right">
                <a href='{{url("militantevip")}}' class="btn btn-block btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Add Militante VIP</a>
              </div>
              <div class="col-lg-3 pull-right">
                <a href='{{url("militantevip/download")}}' class="btn btn-block btn-success">Download XLS</a>
              </div>
              ...
              <thead>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query as $militante) {
                                            ...
                                            <a class="" href="/militantevip/edit/'.$militante->id.'" title="Edit" >
                                            <i data-feather="edit-2" class="fa fa-edit"></i></a>&nbsp;
                                            <a class="" href="/cetak/militantevip/'.$militante->id.'" title="Cetak Surat" ><i data-feather="print"  class="fa fa-print"></i></a>&nbsp;
...
<script type="text/javascript">
  ...
  function delete_user(iduser) {
    if (confirm('Are you sure delete this data?')) {
      ...
      $.ajax({
        url: "{{url('militantevip/delete')}}/" + iduser,
        type: "GET",
        dataType: "JSON",
