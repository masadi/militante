...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1> SMS Koordinator Kabupaten</h1>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                <?php //$this->session->flashdata('pesan')?>
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="sms/sendgroupkoordinatorkabupaten" name="basic_validate" id="basic_validate" novalidate="novalidate" method="POST">
                            <?php
                                $as = array();
                                $option = array();
                                ...
                                foreach ($listkabupaten as $list) {
                                    $option[$list->idkabupaten] = $list->nama_district;
                                }
                            ?>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-4 control-label">Kabupaten koordinator</label>
                                <div class="col-sm-12">
