    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" action="sms/sendgrouppemilihkelurahan" name="basic_validate" id="basic_validate" novalidate="novalidate" method="POST">
