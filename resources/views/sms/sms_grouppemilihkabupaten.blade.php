    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" action="sms/sendgrouppemilihkabupaten" name="basic_validate" id="basic_validate" novalidate="novalidate" method="POST">
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-4 control-label">Kabupaten Pemilih</label>
