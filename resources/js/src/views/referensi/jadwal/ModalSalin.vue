<template>
  <b-modal v-model="salinModalShow" title="Salin Jadwal Ujian" size="xl" @ok="handleOk">
        ...
        <b-row>
          <b-col cols="12">
            <b-form-group label-cols="2" label="Unit" label-for="sekolah_id" :invalid-feedback="feedback.sekolah_id" :state="state.sekolah_id">
              <v-select id="sekolah_id" v-model="form.sekolah_id" :options="data_sekolah" :reduce="nama => nama.sekolah_id" label="nama" placeholder="== Pilih Unit ==" :disabled="true">
                <template #no-options>
